      ...
      // 连接管理
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            privateKey: { type: 'string', description: 'SSH 私钥内容或私钥文件路径（如 /path/to/id_rsa）。password 或 privateKey 至少提供一个' },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            privateKey: { type: 'string', description: '私钥内容或私钥文件路径（如 /path/to/id_rsa）。当 authType=privateKey 时必须提供' },
            passphrase: { type: 'string', description: '私钥密码（仅 privateKey 有密码保护时需要）' },
